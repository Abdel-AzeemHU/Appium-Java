...
/**
 * This class is used to get the configuration properties from the .properties
 * file
 */
	...
	private void loadProperties(final String path) {
		...
		try {
			...
			if (inputStream != null) {
				...
				throw new UnableToLoadPropertiesException("property file '" + path + "' not found in resources folder");
			}
